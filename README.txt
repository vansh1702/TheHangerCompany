...
Made SeedData and added the information 
tested it ,it does not show up the data I inserted, trying to fix the error
On the page i tried to add the information to that it works fine but it doesn't show my SeedData which i inserted
FINALLY WORKED 
I made changes into the program.cs, finally worked. THANK GOD
Now making changes into Hanger.cs
...
Now checking the HangersController.cs
Updated Controllers/MoviesController.cs 
Tested working fine
